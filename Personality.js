const questions = [
  ...
  {
    "question": "Being adaptable is more important than being organized",
    "answer1": "Agree",
    "answer1Total": "1",
    "answer2": "Neutral",
    "answer2Total": "2",
    ...
    if(currentQuestion == totalQuestions) {
        ...
        result.innerHTML =
         ...
         <div class="summary">
            ...
            <p>10 - 15 - Good Soul</p>
            <p>5 - 10 - WOW!! You Are Amazing </p>
            <p>5 - Are You Even Real</p>
        </div>
        <a herf="1stpage.html">
        <button class="restart">Restart Quiz</button></a>
         `;
        return;
    }
...
window.location.herf="D:\IWT\2ND PROGRESS\1stpage.html"("click,back")